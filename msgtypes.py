...
class Message(object):
  ...
  def __init__(self, rpcID, ringID, nodeID):
    self.id = rpcID
    self.ringID = ringID
    self.nodeID = nodeID
...
class RequestMessage(Message):
  ...
  def __init__(self, ringID, nodeID, method, methodArgs, rpcID=None):
    if rpcID == None:
      hash = hashlib.sha1()
      hash.update(str(random.getrandbits(255)))  
      rpcID = hash.digest()
    Message.__init__(self, rpcID, ringID, nodeID)
    self.request = method
...
class ResponseMessage(Message):
  ...
  def __init__(self, rpcID, ringID, nodeID, response):
    Message.__init__(self, rpcID, ringID, nodeID)
...
class ErrorMessage(ResponseMessage):
  ...
  def __init__(self, rpcID, ringID, nodeID, exceptionType, errorMessage):
    ResponseMessage.__init__(self, rpcID, ringID, nodeID, errorMessage)
